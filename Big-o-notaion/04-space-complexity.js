 ...
 * algorithm, not including space taken up by the inputs ( WE CARE ABOUT THE ALGORITHM ITSELF)
 * 
 * 
 *                              Rules of Thumb
 * 
 * 1- most primitives (boolean, undefined , null etc) are const space
 * 2- String requires (O(n) space where n is the String length (if string = 50 character is going to takes 5 * times than a character String)
